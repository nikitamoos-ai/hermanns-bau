...
export default function Testimonials() {
  return (
    <section id="bewertungen" className="py-24 bg-[#f0f4ff]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {reviews.map((r, i) => (
            <motion.div
              ...
              className="bg-white p-8 border-t-4 border-[#cc2020]"
            >
              <div className="flex gap-0.5 mb-4">
                {[...Array(r.stars)].map((_, j) => (
                  <span key={j} className="text-[#cc2020] text-lg">★</span>
                ))}
              </div>
              ...
              <div className="flex items-center justify-between border-t border-gray-100 pt-4">
                <div>
                  <div
                    className="font-bold text-[#1a3a8a] uppercase tracking-wide text-sm"
                    style={{ fontFamily: "var(--font-oswald, sans-serif)" }}
                  >
                    {r.name}
                  </div>
                ...
                <div className="w-8 h-8 bg-[#cc2020] flex items-center justify-center">
