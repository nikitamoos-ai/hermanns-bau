    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-32">
        ...
        <div className="text-sm leading-relaxed space-y-6 text-gray-700">
          <section>
            <h2 className="font-bold text-[#1a3a8a] mb-2">1. Datenschutz auf einen Blick</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-[#1a3a8a] mb-2">2. Verantwortlicher</h2>
            <p>
              Manfred Hermanns Bauunternehmung GmbH<br />
              Dronkestraße 20, 53937 Schleiden<br />
              Tel: 02485/1246
            </p>
          </section>
          <section>
            <h2 className="font-bold text-[#1a3a8a] mb-2">3. Datenerfassung auf dieser Website</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-[#1a3a8a] mb-2">4. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-[#1a3a8a] mb-2">5. Ihre Rechte</h2>
            <p>
